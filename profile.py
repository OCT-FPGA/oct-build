...
if params.toolVersion != "Do not install tools":
  node.addService(pg.Execute(shell="bash", command="sudo /local/repository/post-boot.sh " + params.enableRemoteDesktop + params.toolVersion + " >> /local/repository/output_log.txt"))
pass 
